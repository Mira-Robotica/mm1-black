...
[![CI](https://github.com/Mira-Robotica/mm1-black/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/Mira-Robotica/mm1-black/actions/workflows/ci.yml)
[![Release](https://img.shields.io/badge/dynamic/json?label=release&query=%24.tag_name&url=https%3A%2F%2Fapi.github.com%2Frepos%2FMira-Robotica%2Fmm1-black%2Freleases%2Flatest&color=orange&logo=github)](https://github.com/Mira-Robotica/mm1-black/releases/latest)
[![Firmware installer](https://img.shields.io/badge/firmware-install%20page-blue)](https://mira-robotica.github.io/mm1-black/firmware/)
![PlatformIO](https://img.shields.io/badge/PlatformIO-ESP32-blue)

**Firmware update:** [mira-robotica.github.io/mm1-black/firmware](https://mira-robotica.github.io/mm1-black/firmware/) — Wi-Fi or USB UART; also via QR on the device (**SETUP → About**).
...
- **[Web installer](https://mira-robotica.github.io/mm1-black/firmware/)** — Chrome/Edge, Wi-Fi or USB UART ([docs/OTA.md](docs/OTA.md), [docs/flasher/DEPLOY.md](docs/flasher/DEPLOY.md))
